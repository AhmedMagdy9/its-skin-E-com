...
products!:Product[]
categories = ["شامبو",  "بلسم",  "ليف ان",  "سيرم شعر","ماسك شعر" ,"هيت بروتكتور" ,    "تريتمنت", "سبوت تريتمنت" ,   "غسول",  "غسول زيتي", "مرطب",   "صن سكرين",   "سيرم",  "ايسنس",  "تونر",  "مقشر", "كريم عين", "ماسك وجة" , "شفرات سكرين" , "معجون اسنان" , "ديودرانت" , "اخري"];
